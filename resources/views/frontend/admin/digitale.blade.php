  ...
  <body>
                  ...
                  <div class="card-body">
                    <div class="container-fluid" style="min-height: 375px">
                      <div class="text-center mb-4">
                        <h2 class="text-primary">Transformation digitale</h2>
                      </div>
    ...
    <script>
      ...
      var themeChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['Trés accessible', 'Accessible', 'Moyennement accessible', 'Difficilement accessible', 'Trés difficilement accessible'],
          datasets: [{
            label: 'Évaluations',
            data: [12, 19, 8, 5, 2],

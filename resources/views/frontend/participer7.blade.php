...
.star-rating {
 ...
 input[type="checkbox"] {
    ...
    max-width: 300px; /* Largeur maximale pour centrer les blocs */
...
<div class="buttons">
   ...
   <!-- scriopt de l'affichage du choix senegal de ses departement et de ses regions------------------------------------------------------------------------->
        <script>
...
function loadRegions() {
  ...
  <!-- scrript de l'affichage des pays de la diaspora ------------------------------------------------------------------------------------------------>
...
<script>
  ...
  <!-- scrript pour basculer lorsqu'on veut donner notre avis de manière anonyme ------------------------------------------------------------------------------------------------>
...
<script>
 ...
 <!-- scrript pour que le bouton suivant passe ----------------------------------------------------------------------------------------------------------------------------->
...
<!-- script pour afficher les questions apres avoir cliqué sur un secteur------------------------------------------------------------------------------------------------>
...
<!-- script pour afficher les questions apres avoir cliqué sur le secteur de la santé------------------------------------------------------------------------------------------------>
...
<!-- script pour afficher les questions apres avoir cliqué sur le secteur de l'éducation------------------------------------------------------------------------------------------------>
...
<!-- script pour afficher les questions apres avoir cliqué sur le secteur du transport------------------------------------------------------------------------------------------------>
...
<!-- script pour afficher les questions apres avoir cliqué sur le blog autre----------------------------------------------------------------------------------------------->
...
<!-- script pour afficher les questions apres avoir cliqué sur le blog autre sur le secteur de l'énergie----------------------------------------------------------------------------------------------->
...
<!-- script pour afficher les questions apres avoir cliqué sur le blog autre sur le secteur de la police----------------------------------------------------------------------------------------------->
...
<!-- script pour afficher les questions apres avoir cliqué sur le blog autre sur le secteur financier----------------------------------------------------------------------------------------------->

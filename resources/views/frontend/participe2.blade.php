...
<header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
        <a href="{{ route('home') }}" class="logo d-flex align-items-center">
            ...
            <img src="assets/img/logg.png" alt="Logo" style="height: 100px; width: auto;">
        </a>

        <!-- Menu de navigation sans éléments <li> -->
        <nav id="navmenu" class="navmenu">
            <!-- Aucun <ul> et <li>, juste un espace pour les liens -->
    ...
    <div class="intro-section" id="intro-section">
      ...
      <div class="section-options">
        ...
        <div class="flex-container">
          ...
          <div class="block-wrapper">
  <div class="block">
    <!-- Lien vers la page d'avis général avec la route nommée -->
    <a href="{{ route('general.feedback') }}">
      <button>
...
<div class="block-wrapper">
  <div class="block">
    <!-- Lien vers la page d'avis par secteur avec la route nommée -->
    <a href="{{ route('sector.feedback') }}">
      <button>

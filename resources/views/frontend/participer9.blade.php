  ...
  .btn-return:hover {
    ...
    <div class="main-content">
        ...
        <div id="formAccesPublics" class="hidden-section">
            ...
            <form id="formAccesPublicsForm" class="needs-validation" novalidate>
...
2-php artisan make:model PaysMonde
app modele paysMonde
3 créer une rout
use App\Http\Controllers\PaysMondeController;

Route::get('/residence', [PaysMondeController::class, 'index']);

créer un copntroller

php artisan make:controller PaysMondeController

on va dans paysmondecontroller.php



le truc c'est que c'est pays résidece controller c'est paysMondeController.php
-->
